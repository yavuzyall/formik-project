    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className='inputDiv'>
                ...
                <input type="password" value={ values.confirmPassword } onChange={handleChange} id='confirmPassword' placeholder='Şifrenizi tekrar giriniz.' className={errors.email ? 'input-error' : ''}/>
