...
export const advancedSchema = yup.object().shape({
    ...
    university: yup.string().oneOf(['bogazici','gsu','deu','odtü','itü'], 'Lütfen üniversitenizi seçiniz').required('Lütfen üniversitenizi seçiniz'),
    isAccepted: yup.boolean().oneOf([true], 'Kullanım koşulları kabul edilmeli')
});